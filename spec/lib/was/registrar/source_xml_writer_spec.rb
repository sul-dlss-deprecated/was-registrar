...
describe Was::Registrar::RegisterSeedObject do
  ...
  describe ".write_xml" do
    it "should write a valid xml file" do
      ...
      seed_hash = {"id"=>23, "druid_id"=>"druid:aa111aa1111", "uri"=>"http://www.slac.stanford.edu/",
                    "embargo"=>false, "source"=>nil, "collection_id"=>"druid:gz033bg3146",
                    ...
                    "source_file"=>nil, "import_date"=>nil, "created_at"=>"Tue, 09 Dec 2014 18:55:54 UTC +00:00",
                    "updated_at"=>"Thu, 11 Dec 2014 15:47:47 UTC +00:00", "verified"=>nil, "source_id"=>"was:a", "rights"=>"world"}
